 ...
 * HOTSPOT GAME       *
 ********************/
var HotspotExperiment = function() {

    psiTurk.showPage('hotspot.html');
};
 ...
 * Debriefing       *
 ********************/
var Debrief = function(payoffInfo) {
    console.log(payoffInfo);
...
var Questionnaire = function() {
	...
	var error_message = "<h1>Oops!</h1><p>Something went wrong. This might happen if you lose your internet connection. Press the button to resubmit.</p><button id='resubmit'>Resubmit</button>";
	...
	$("#next").click(function () {
	    ...
	    psiTurk.saveData({
            success: function(){
                currentview = new HotspotExperiment();
//                psiTurk.completeHIT(); // when finished saving compute bonus, the quit
